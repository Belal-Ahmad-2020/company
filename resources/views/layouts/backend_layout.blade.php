...
<html lang="en" dir="ltr">
  ...
  <title>@yield('title', "Mansoori Company")</title>
  ...
  <link rel="stylesheet" href="{{ asset('backend/assets/plugins/toaster/toastr.min.css') }}">
  <link rel="stylesheet" href="{{ asset('backend/assets/plugins/nprogress/nprogress.css') }}">
  <link rel="stylesheet" href="{{ asset('backend/assets/plugins/flag-icons/css/flag-icon.min.css') }}">
  <link rel="stylesheet" href="{{ asset('backend/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}">
  <link rel="stylesheet" href="{{ asset('backend/assets/plugins/ladda/ladda.min.css') }}">
  <link rel="stylesheet" href="{{ asset('backend/assets/plugins/select2/css/select2.min.css') }}">
  <link rel="stylesheet" href="{{ asset('backend/assets/plugins/daterangepicker/daterangepicker.css') }}">


  <!-- SLEEK CSS -->  
    <link rel="stylesheet" href="{{ asset('backend/assets/css/sleek.css') }}">
      ...
      <div class="page-wrapper">
        ...
        <footer class="footer mt-auto">
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">{{ date('Y') }}</span> Copyright Belal Mansoori Company
                <a
                  class="text-primary"
